...
class CreateImsRooitClassTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ims_rooit_class_type', function (Blueprint $table) {
            $table->increments('typeid')->comment('约课类型id');
    ...
    {
        Schema::dropIfExists('ims_rooit_class_type');
    }
}
