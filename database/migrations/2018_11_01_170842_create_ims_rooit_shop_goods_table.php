...
class CreateImsRooitShopGoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ims_rooit_shop_goods', function (Blueprint $table) {
            ...
            $table->decimal('old_price', 2)->default(0)->comment('原价');
            $table->decimal('price', 2)->default(0)->comment('售价');
    ...
    {
        Schema::dropIfExists('ims_rooit_shop_goods');
    }
}
